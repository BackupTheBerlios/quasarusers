...
<!-- $Id: site.xsl,v 1.1 2003/03/25 22:16:41 schmickler Exp $ -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:variable name="banner-bg"     select="'#dddddd'"/>
  <xsl:variable name="banner-fg"     select="'#000000'"/>
  <xsl:variable name="sub-banner-bg" select="'#dddddd'"/>
  <xsl:variable name="sub-banner-fg" select="'#000000'"/>
    ...
    <table border="0" width="100%" cellspacing="4">
      ...
      <tr><td colspan="2">
        ...
        <A href="http://developer.berlios.de">
            <IMG src="http://developer.berlios.de/bslogo.php?group_id=743" width="124" height="32" border="0" alt="BerliOS Developer Logo"/>
        </A>
    ...
    <xsl:variable name="href">
      <xsl:choose>
            ...
            <xsl:when test="starts-with(@href, '/site')">
                <xsl:text>http://quasarusers.berlios.de</xsl:text><xsl:value-of select="@href"/>
            </xsl:when>
            <xsl:otherwise>
